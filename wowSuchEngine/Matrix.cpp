...
bool JoshoEngine::operator==(const Matrix& a, const Matrix& b)
{
...
Matrix JoshoEngine::operator+(const Matrix& a, const Matrix& b)
{
...
Matrix JoshoEngine::operator+(const Matrix& a, float b)
{
...
Matrix JoshoEngine::operator+(float a, const Matrix&b)
{
