...
const Color Color::Tomato(255.0f / 255.0f, 99.0f / 255.0f, 71.0f / 255.0f); // yuck
...
{
	this->r = Helper::clamp(r, 0.0f, 1.0f);
	this->g = Helper::clamp(g, 0.0f, 1.0f);
	this->b = Helper::clamp(b, 0.0f, 1.0f);
	this->a = Helper::clamp(a, 0.0f, 1.0f);
}
