#ifndef JOSHOENGINE_COLOR_H_
#define JOSHOENGINE_COLOR_H_

#include "JoshoEngine.h"

namespace JoshoEngine
{
	struct JOSHO_API Color
	{
		// Thanks XNA! ;)
		...
		// Constructs a new color, black.
		Color();

		// Copies a color.
		Color(const Color& orig);

		// Instantiates a Color object with the component values specified.
		Color(float r, float g, float b, float a = 1.0f);

		// Instantiates a Color object by a 24-bit representation.
		// MSB is r, middle is b, LSB is g.
